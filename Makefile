OBJS = direct_ref_b.o rgba_alpha_ref_b.o direct_magic_ref_b.o mapped_ref_b.o brswap_ref_conv.o blconv.o blfmt.o blimg.o bltmp.o bltmp_acquire.o blit.o
...
rgba_alpha_ref_b.o: rgba_alpha_ref_b.c nbb.h
	$(CC) $(CFLAGS) -c -fPIC -o rgba_alpha_ref_b.o rgba_alpha_ref_b.c
...
brswap_ref_conv.o: brswap_ref_conv.c nbb.h
	$(CC) $(CFLAGS) -c -fPIC -o brswap_ref_conv.o brswap_ref_conv.c
